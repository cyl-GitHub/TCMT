                ...
                <div class="menu-wrap">
                    <nav class="menu">
                        <ul class="clearfix">
                            ...
                            <%--主治--%>
                            <li class="top-nav">
                                <a href="/jspController/IndicationsChinese" class="top">Indications</a>
                            </li>
                            <li class="top-nav">
                                <%--关于TMCT--%>
                            ...
                            <li class="top-nav">
                                <%--收费标准--%>
                                <a href="/jspController/CostEnglish" class="top   current-item">Cost</a>
                            </li>
                            ...
                            <li class="top-language">
                                <a class="top" style="border-left:none;">
                                    ...
                                    <select id="langsel" onchange="switchlang4(this.value);">
    ...
    <div class="container-padding pg-container ">
        ...
        <div class="pg-col-r">
            ...
            <div id="gencontent" class="general"><!--general!-->
                ...
                <div id="">
                    <div class="widget riche">Tcmt is committed to creating a one-stop TCM service of "medical
                        treatment, accompany and tourism" for patients. We adopt a comprehensive escort service system
                        to create a 24-hour online service, care service and tour guide service for institutions in
                        terms of medical treatment, accompany, tourism and translation.
                    ...
                    <div class="widget riche">
                        <%--todo 服务项目--%>
                        <h3>Treatment</h3>
                        After confirming the treatment in China, the platform will provide treatment options and online
                        consultation for the patients according to the specific conditions and conditions of the
                        patients and the actual situation, with an intermediary fee of 2300 yuan.
                        <br>&nbsp;<br>

                        <h3>Chaperone</h3>
                        For patients who come to China for treatment, we can provide accompanying services,
                        consultation, accompanying medical treatment, tour guide and other services when necessary, and
                        charge 200-1000 yuan / day according to different skills (translation, proficiency, etc.) and
                        regions.
                        <br>&nbsp;<br>

                        <h3>Life</h3>
                        According to the patient's physical condition and economic situation, provide accommodation
                        services in the treatment location, and provide food for the patients in some areas at their own
                        expense.
                        <br>&nbsp;<br>

                        <h3>Entertainment</h3>
                        In the spare time of treatment, patients can be guided (voluntarily) to visit some tourist
                        attractions, or to taste local characteristics or buy souvenirs, for 600 yuan.
                        <br>&nbsp;<br>
