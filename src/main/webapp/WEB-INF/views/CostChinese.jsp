            ...
            <div id="gencontent" class="general"><!--general!-->
                ...
                <div id="">
                    <div class="widget riche">TCMT致力于为患者打造一个“医疗、陪护、旅游”中医一站式服务，我们采用全面陪同服务体系，全方位从
                        ...
                        等方面，打造包含——机构24小时在线服务、照料服务、导游服务。并根据当地物价和服务项目收取费用。
                        <br>&nbsp;<br>
                    ...
                    <div class="widget riche">
                        <%--todo 收费标准--%>
                            <h3>治疗</h3>
                            在确定来华治疗后,由本平台根据患者具体情况和病情并结合实际情况,为患者提供治疗选择,并提供在线咨询,中介费2300元
                            <br>&nbsp;<br>

                            <h3>陪护</h3>
                            对来华治疗的患者,可提供陪护服务,在有需要的时候提供咨询,陪同看病,导游等服务,根据按技能掌握不同(翻译,熟练度等)和地区不同收取200~1000元/天.
                            <br>&nbsp;<br>

                            <h3>生活</h3>
                            根据患者身体状况和经济情况,在治疗所在地提供住宿服务,并在部分地区可提供患者所需要的食品,自费.
                            <br>&nbsp;<br>

                            <h3>娱乐</h3>
                            在治疗的空余时间,可引导患者(自愿)前往部分旅游景点进行游览,也可前往品尝当地特色或购买纪念品,收取600元.
                            <br>&nbsp;<br>
                    </div>
                    <div class="clear hwsep"></div>
                </div>
