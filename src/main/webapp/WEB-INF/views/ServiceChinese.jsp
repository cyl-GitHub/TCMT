                ...
                <div class="menu-wrap">
                    <nav class="menu">
                        <ul class="clearfix">
                            ...
                            <li class="top-nav"><a href="/jspController/ServiceChinese"
                                                   class="top    current-item">服务项目</a>
                            </li>
                            <li class="top-nav">
            ...
            <div id="gencontent" class="general"><!--general!-->
                ...
                <div id="">
                    ...
                    <div class="widget riche">
                        <%--todo 服务项目--%>
                        <h3>治疗</h3>
                        在确定来华治疗后,由本平台根据患者具体情况和病情并结合实际情况,为患者提供治疗选择,并提供在线咨询
                        <br>&nbsp;<br>

                        <h3>陪护</h3>
                        对来华治疗的患者,可提供陪护服务,在有需要的时候提供咨询,陪同看病,导游等服务
                        <br>&nbsp;<br>

                        <h3>生活</h3>
                       根据患者身体状况和经济情况,在治疗所在地提供住宿服务,并在部分地区可提供患者所需要的食品
                        <br>&nbsp;<br>

                        <h3>娱乐</h3>
                        在治疗的空余时间,可引导患者(自愿)前往部分旅游景点进行游览,也可前往品尝当地特色或购买纪念品
                        <br>&nbsp;<br>
