                ...
                <div class="menu-wrap">
                    <nav class="menu">
                        <ul class="clearfix">
                            ...
                            <li class="top-nav">
                                <%--服务项目--%>
                                <a href="/jspController/ServiceEnglish" class="top    current-item">Service</a>
                            </li>
                            <li class="top-nav">
                                <%--收费标准--%>
                            ...
                            <li class="top-language">
                                <a class="top" style="border-left:none;">
                                    ...
                                    <select id="langsel" onchange="switchlang3(this.value);">
            ...
            <div id="gencontent" class="general"><!--general!-->
                ...
                <div id="">
                    ...
                    <div class="widget riche">
                        ...
                        consultation for patients according to the specific situation and condition of patients and the
                        actual situation
                        <br>&nbsp;<br>

                        <h3>Chaperone</h3>
                        For patients who come to China for treatment, we can provide accompanying services,
                        consultation, accompanying and tour guide when necessary
                        <br>&nbsp;<br>

                        <h3>Life</h3>
                        According to the patient's physical condition and economic situation, provide accommodation
                        services in the treatment location, and provide the food needed by the patient in some areas
                        <br>&nbsp;<br>

                        <h3>Entertainment</h3>
                        In the spare time of treatment, patients can be guided (voluntarily) to visit some tourist
                        attractions, or to taste local characteristics or buy souvenirs
                        <br>&nbsp;<br>
