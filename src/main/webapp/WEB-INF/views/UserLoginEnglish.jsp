...
<head>
    ...
    <script src="/static/js/user/loginE.js"></script>
    ...
    <div class="container-padding pg-container ">
        ...
        <div class="pg-col-l">
            <ul class="nav-left">
                ...
                <li class="current" onclick="goUrl('/jspController/UserLoginEnglish');">
                    User login
                </li>
                        ...
                        <form name="ifrm" id="ifrm" method="post">
                            <blockquote id="tab1" class="">
                                    ...
                                    <div class="clrfix">
                                        <div class="input-box">
                                            <input id="description" name="description" type="text" onkeydown="KeyDown()"
                                                   ...
                                                   placeholder="Please enter the symptom">
                                            <div class="jyts-err">
                                    ...
                                    <div class="input-item fl clrfix w-180">
                                        <div class="input-box">
                                            <input name="code" id="code" autocomplete="off" type="text"
                                                   onkeydown="KeyDown()"
                                                   class="inputNumber AppCheck nocheck data w-120"
                                ...
                                <div style="width: 100%;height: 40px">
                                    ...
                                    <div>
                                        <input type="button" value="change" onclick="changeImg()" style="float: left">
                                    </div>
                                </div>

                                <div id="divAll" style="width: 500px;color: red;font-size:18px;text-align: left">
                                ...
                                <div>
                                    ...
                                    <input type="button" class="but" id="user-btn1" value="submit" onclick="login()">
                                </div>
